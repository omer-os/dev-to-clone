    ...
    <div className="sm:flex hidden flex-col gap-5">
      {[
        ...
        <Link
          key={index}
          href={`/${tag.name}`}
          className="flex hover:bg-indigo-700/50 p-2 rounded hover:underline bg-black transition-all hover:text-indigo-400 text-white text-sm gap-3 active:scale-95"
        >
          <i>{tag.svg}</i>
          <p>{tag.name}</p>
        </Link>
